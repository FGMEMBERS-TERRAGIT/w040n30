FG Tile |  w040n30 Terrain for FGMEMBERS-TerraGIT
-------------------------------------------------
...
* 2018 CORINE Landclasses for Europe: http://www.eea.europa.eu/publications/COR0-landcover
* 2020 OSM shape polygons for landmass (Default) and Antartica (PolarIce): http://openstreetmapdata.com/data/land-polygons
* 2020 OSM comprehensive custom landclasses: http://download.geofabrik.de/

The terrain was reconstructed on __marvin__. An ubuntu based computer kindly offered as a resource by
David Waggoner (Skyboat) for this purpose.
